...
class Options:
    ...
    def OptionsQuotes(self):
        ...
        # url = "https://api.etrade.com/v1/market/quote/GOOG.json"
        url = self.base_url + "/v1/market/quote/" + symbols + ".json"

        # https://api.etrade.com/v1/market/optionchains?symbol={symbol}
        # url = "https://api.etrade.com/v1/market/optionchains?symbol=goog.json"
        # url = "https://api.etrade.com/v1/market/optionchains?symbol=GOOG&expiryYear=2024&expiryMonth=02&strikePriceNear=142&noOfStrikes=10"
        # url = self.base_url + "/v1/market/optionchains?symbol=" + symbols # + ".json"

        # "https://api.etrade.com/v1/market/optionexpiredate?symbol=GOOG&amp;expiryType=ALL"
        # url = "https://api.etrade.com/v1/market/optionexpiredate?symbol=GOOG&amp;expiryType=ALL"
